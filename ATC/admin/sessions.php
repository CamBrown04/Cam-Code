            ...
            <div class="admin-section-column">
                <div class="admin-section-panel admin-section-stats">
                    <div class="admin-section-stats-panel">
                        <i class="fas fa-ticket-alt" style="background-color: #FF7F50"></i>
                        <h2 style="color: #FF7F50"><?php echo $bookingsNo ?></h2>
                        <h3>Bookings</h3>
                    </div>
                    <div class="admin-section-stats-panel">
                ...
                <div class="admin-section-panel admin-section-panel2">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" value="submit" name="submit" class="form-btn">Add Session</button>
                        <?php
...
class SubmittedFeedback extends RecursiveIteratorIterator {
